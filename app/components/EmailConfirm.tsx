      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Row>
              <Column>
                <Img src={`${baseUrl}/email-sent.png`} width="42" height="42" alt="Apple Logo" />
              </Column>
          ...
          <Section>
            <Text style={cupomText}>
              <sup style={supStyle}>1</sup> <sup style={supStyle}>2</sup>
            </Text>
          </Section>
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn} colSpan={2}>
                ...
                <Text style={informationTableValue}>Visa .... </Text>
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Shinobi Store</Text>
          </Section>
          <Section>
            {products.map((product, i: number) => {
              const finalPrice = calculateFinalPrice(product.price, product.variants, product.variations);
              return (
                <Row key={i}>
                  ...
                  <Column style={{ paddingLeft: "22px" }}>
                    ...
                    <Text style={productDescription}>{product.description.slice(0, 50)}</Text>
                    <Link
                  ...
                  <Column style={productPriceWrapper} align="right">
                    <Text style={productPrice}>{formatPrice(finalPrice)}</Text>
                  </Column>
                </Row>
              );
            })}
          ...
          <Section>
            <Row>
              <Column align="center" style={block}>
                <Img src={`${baseUrl}/static/apple-card-icon.png`} width="60" height="17" alt="Apple Card" />
              </Column>
            </Row>
          </Section>
          <Section>
          ...
          <Text style={footerCopyright}>
            Copyright ©2025 Muslim Kids <br /> <Link href="https://www.apple.com/legal/">All rights reserved</Link>
          </Text>
        </Container>
      </Body>
    </Html>
